...
export default function Error({
  ...
  return (
    <div className="flex min-h-[400px] flex-col flex-1 items-center justify-center space-y-4 text-center">
      ...
      <p className="text-gray-600">An error occurred while signing in.</p>
      <button
        onClick={() => reset()}
